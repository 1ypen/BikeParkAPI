    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='format: required, char, max-255', max_length=255, verbose_name='Название')),
                ('cover_image', models.ImageField(upload_to='media/bicycle/')),
        ...
        migrations.AddField(
            model_name='bicycle',
            name='images',
            field=models.ManyToManyField(to='catalog.Media'),
        ),
    ]
